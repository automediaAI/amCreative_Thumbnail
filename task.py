...
input_file = 'input/youtubeCovidDaily.png'
output_filename = 'ytCovidDaily-'+ today.strftime("%b-%d-%Y")

## Main function to create
def create_frame(
	text_entry = 'January 23, 2021',
	input_file = 'input/youtubeCovidDaily.png',
	file_type = 'file',
	outputfilename='output_alpha',
	):
...
def dumpToAirtable(inputURL):
	...
	UUID = 'ytThumb-'+str(shortuuid.uuid()) #to create unique file name
